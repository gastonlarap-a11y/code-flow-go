      ...
      >
        <div className="flex items-start gap-3 border-b border-[var(--cf-border)] p-4">
          ...
          <div className="min-w-0 flex-1">
            <h2 id={titleId} className="text-relaxed font-semibold text-[var(--cf-text)]">{t("secrets.title")}</h2>
            <p className="mt-0.5 text-ui text-[var(--cf-text-muted)]">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body font-medium text-[var(--cf-text)]">{hit.rule_name}</span>
                  <span
                    className="ml-auto shrink-0 rounded-full px-1.5 py-0.5 text-badge font-semibold uppercase"
                ...
                <div className="mt-1 flex items-center gap-1 text-badge text-[var(--cf-text-muted)]">
                  <MapPin size={11} className="shrink-0" />
                  <span className="truncate font-mono">
                    {hit.file}:{hit.line}
                  </span>
                </div>
                <code className="mt-1 block truncate rounded bg-black/[0.04] px-1.5 py-1 font-mono text-badge text-[var(--cf-text)] dark:bg-white/[0.06]">
                  {hit.preview}
                </code>
              </li>
            );
        ...
        <div className="flex items-center justify-between gap-2 border-t border-[var(--cf-border)] p-3">
          ...
          <div className="flex gap-2">
            {/* "Commit anyway" is the dangerous half of this dialog, and the safe one keeps focus. */}
            <Button variant="danger" onClick={onCommitAnyway}>
