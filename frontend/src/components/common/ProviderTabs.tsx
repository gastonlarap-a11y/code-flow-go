      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={`relative flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-ui font-medium ${
              active
          ...
          >
            ...
            <span className="relative flex items-center gap-1.5">
              ...
              {/* `text-badge` is the scale's floor; this badge was set at 9px, two steps under it. */}
              {!opt.available && (
                <span className="ml-0.5 rounded-full bg-black/10 px-1.5 py-0.5 text-badge font-semibold uppercase tracking-wide dark:bg-white/10">
