...
function lookupInScope(name: string, scope: VariableScope, ctx: VariableContext): string | null {
  switch (scope) {
    case "local":
      return Object.prototype.hasOwnProperty.call(ctx.local, name) ? (ctx.local[name] ?? null) : null;
    case "data":
      return Object.prototype.hasOwnProperty.call(ctx.data, name) ? (ctx.data[name] ?? null) : null;
    case "environment":
