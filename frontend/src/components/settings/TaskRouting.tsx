        ...
        return (
          <div key={task.key} className="rounded-lg border border-[var(--cf-border)] p-2.5">
            <div className="mb-1.5">
              <p className="text-body font-medium text-[var(--cf-text)]">{t(task.labelKey)}</p>
              <p className="text-badge leading-snug text-[var(--cf-text-muted)]">{t(task.hintKey)}</p>
            </div>
            ...
            {broken && (
              <p className="mt-1.5 flex items-start gap-1 text-badge leading-snug text-[var(--cf-danger)]">
