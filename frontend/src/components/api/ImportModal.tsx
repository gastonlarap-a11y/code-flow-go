...
export function ImportModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <ApiModal
      ...
      fill
      busy={importing}
      // The webview only reports a file drop over an element carrying `data-file-drop-target`;
      // this puts it on the full-screen scrim, which is what makes "drop anywhere while the
      // modal is open" keep working.
      fileDropTarget
      onClose={onClose}
      footer={
        <>
