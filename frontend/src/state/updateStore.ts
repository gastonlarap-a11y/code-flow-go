...
import { check, getVersion, relaunch, type Update } from "../lib/bridge/updater";
 ...
 *
 * Nothing here works in a plain dev server: the updater replaces an installed binary and there isn't
