...
export function ClaudeSettings() {
  ...
  return (
    <section>
      <h3 className="mb-1 text-title font-semibold">{t("settings.aiSectionTitle")}</h3>
      <p className="mb-4 text-relaxed text-[var(--cf-text-muted)]">{t("settings.aiSectionHint")}</p>
